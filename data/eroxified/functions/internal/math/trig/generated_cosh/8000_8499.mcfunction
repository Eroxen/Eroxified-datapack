scoreboard players set math.trig.y eroxified.internal 1913813
...
scoreboard players remove math.trig.x-a eroxified.internal 8250
scoreboard players set math.trig.y_acc eroxified.internal 1913812
...
scoreboard players set math.trig.y_acc eroxified.internal 956906
scoreboard players operation math.trig.y_acc eroxified.internal *= math.trig.x-a eroxified.internal
scoreboard players operation math.trig.y_acc eroxified.internal /= math.trig.op eroxified.internal
scoreboard players operation math.trig.y_acc eroxified.internal *= math.trig.x-a eroxified.internal
scoreboard players operation math.trig.y_acc eroxified.internal /= math.trig.op eroxified.internal
