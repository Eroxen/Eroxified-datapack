scoreboard players set math.trig.y eroxified.internal 704052
...
scoreboard players remove math.trig.x-a eroxified.internal 7250
scoreboard players set math.trig.y_acc eroxified.internal 704052
...
scoreboard players set math.trig.y_acc eroxified.internal 352026
scoreboard players operation math.trig.y_acc eroxified.internal *= math.trig.x-a eroxified.internal
scoreboard players operation math.trig.y_acc eroxified.internal /= math.trig.op eroxified.internal
scoreboard players operation math.trig.y_acc eroxified.internal *= math.trig.x-a eroxified.internal
scoreboard players operation math.trig.y_acc eroxified.internal /= math.trig.op eroxified.internal
