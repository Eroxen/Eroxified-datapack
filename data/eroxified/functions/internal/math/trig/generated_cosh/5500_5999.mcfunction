scoreboard players set math.trig.y eroxified.internal 157096
...
scoreboard players remove math.trig.x-a eroxified.internal 5750
scoreboard players set math.trig.y_acc eroxified.internal 157093
...
scoreboard players set math.trig.y_acc eroxified.internal 78548
scoreboard players operation math.trig.y_acc eroxified.internal *= math.trig.x-a eroxified.internal
scoreboard players operation math.trig.y_acc eroxified.internal /= math.trig.op eroxified.internal
scoreboard players operation math.trig.y_acc eroxified.internal *= math.trig.x-a eroxified.internal
scoreboard players operation math.trig.y_acc eroxified.internal /= math.trig.op eroxified.internal
