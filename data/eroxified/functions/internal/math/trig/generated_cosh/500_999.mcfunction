scoreboard players set math.trig.y eroxified.internal 1294
...
scoreboard players remove math.trig.x-a eroxified.internal 750
scoreboard players set math.trig.y_acc eroxified.internal 822
...
scoreboard players set math.trig.y_acc eroxified.internal 647
scoreboard players operation math.trig.y_acc eroxified.internal *= math.trig.x-a eroxified.internal
scoreboard players operation math.trig.y_acc eroxified.internal /= math.trig.op eroxified.internal
scoreboard players operation math.trig.y_acc eroxified.internal *= math.trig.x-a eroxified.internal
scoreboard players operation math.trig.y_acc eroxified.internal /= math.trig.op eroxified.internal
