scoreboard players set math.trig.y eroxified.internal 1160786
...
scoreboard players remove math.trig.x-a eroxified.internal 7750
scoreboard players set math.trig.y_acc eroxified.internal 1160785
...
scoreboard players set math.trig.y_acc eroxified.internal 580393
scoreboard players operation math.trig.y_acc eroxified.internal *= math.trig.x-a eroxified.internal
scoreboard players operation math.trig.y_acc eroxified.internal /= math.trig.op eroxified.internal
scoreboard players operation math.trig.y_acc eroxified.internal *= math.trig.x-a eroxified.internal
scoreboard players operation math.trig.y_acc eroxified.internal /= math.trig.op eroxified.internal
