scoreboard players set math.trig.y eroxified.internal 8577114
...
scoreboard players remove math.trig.x-a eroxified.internal 9750
scoreboard players set math.trig.y_acc eroxified.internal 8577114
...
scoreboard players set math.trig.y_acc eroxified.internal 4288557
scoreboard players operation math.trig.y_acc eroxified.internal *= math.trig.x-a eroxified.internal
scoreboard players operation math.trig.y_acc eroxified.internal /= math.trig.op eroxified.internal
scoreboard players operation math.trig.y_acc eroxified.internal *= math.trig.x-a eroxified.internal
scoreboard players operation math.trig.y_acc eroxified.internal /= math.trig.op eroxified.internal
