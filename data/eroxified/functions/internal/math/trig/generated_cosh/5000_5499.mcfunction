scoreboard players set math.trig.y eroxified.internal 95285
...
scoreboard players remove math.trig.x-a eroxified.internal 5250
scoreboard players set math.trig.y_acc eroxified.internal 95280
...
scoreboard players set math.trig.y_acc eroxified.internal 47642
scoreboard players operation math.trig.y_acc eroxified.internal *= math.trig.x-a eroxified.internal
scoreboard players operation math.trig.y_acc eroxified.internal /= math.trig.op eroxified.internal
scoreboard players operation math.trig.y_acc eroxified.internal *= math.trig.x-a eroxified.internal
scoreboard players operation math.trig.y_acc eroxified.internal /= math.trig.op eroxified.internal
