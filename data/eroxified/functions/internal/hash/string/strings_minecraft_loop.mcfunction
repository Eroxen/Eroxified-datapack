data modify storage eroxified:internal hash.string set string storage eroxified:internal hash.strings[0] 10
...
execute if data storage eroxified:internal hash.strings[0] run function eroxified:internal/hash/string/strings_minecraft_loop