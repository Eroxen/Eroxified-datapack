...
function #eroxified:placed_head_despawn_attempt
...
execute if score player_head_blocks.despawn eroxified.internal matches 1 run function #eroxified:placed_head_despawn
